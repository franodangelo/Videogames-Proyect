...
export default function Card({ name, img, rating, genres }) {
    return (
        <main className="flex flex-col w-full px-4 py-8 justify-center -lg bg-shades-500 shadow-lg shadow-palette-600/50">
            <h2 className="mb-2 px-2 py-1 self-end text-xs text-white bg-palette-100 -full">{rating.toFixed(1)}</h2>
