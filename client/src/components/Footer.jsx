...
export default function Footer() {
    return (
        <footer className="flex flex-col md:flex-row w-full h-40 md:h-20 mt-auto px-8 justify-center gap-8 md:justify-between md:gap-0 items-center text-white bg-slate-800">
